...
$('div#content_439').fadeIn(0);
	openWindow=439;

	}
});

$('#patch_437').click(function(){
		if (openWindow==437){
		openWindow=0;
	$('div#content_437').fadeOut(0);
	} else {
