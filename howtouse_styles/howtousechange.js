...
$("div#tut_text_2").html("Как и в разделе 'Звезды и созвездия' информация о всех небесных объектах выдается по щелчку на них.");
...
$("div#tut_text_4").html("Если Вам нужно узнать расположение планет в какой-то конкретный день, то введите дату в отведенные для этого поля, и программа отобразит положение планет в выбранный момент времени.");
...
$("div#tut_text_1").html("В Spacemap можно найти информацию о созвездиях северной части небесной сферы, для этого нужно лишь ввести имя искомого созвездия в поисковую строку. После этого программа отобразит на карте только это созвездие и выведет список всех звезд, которые входят в него. По щелчку на элемент списка, вы сможете узнать всю информацию о звезде.");
$("div#tut_text_2").html("Если Вы хотите узнать, какие звезды можно наблюдать при хороших погодных условиях в Вашем регионе, то стоит просто ввести нужную дату и время в поля ввода, и после этого на карте отобразятся все звезды, которые можно увидеть.");
$("div#tut_text_3").html("Если Вам сложно понять что находится на том или ином участке карты, или созвездие слишком мало чтобы его увидеть, то Вы можете воспользоваться лупой: после ее активации наведите курсор на непонятное место на карте, и регулируйте разрешение колесиком мышки.");
