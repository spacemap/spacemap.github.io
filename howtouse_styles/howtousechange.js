...
$("#tut_photo_1").attr({
src:'howtouse_styles/cursor_tut.png'
});
$("#tut_photo_2").attr({
src:'howtouse_styles/info_tut.png'
});
$("#tut_photo_3").attr({
src:'howtouse_styles/planetmotion_tut.png'
});
$("#tut_photo_4").attr({
src:'howtouse_styles/showfuture_tut.png'
});
...
$("#tut_photo_1").attr({
src:'howtouse_styles/constel_tut.png'
});

$("#tut_photo_2").attr({
src:'howtouse_styles/localsky_tut.png'
});
$("#tut_photo_3").attr({
src:'howtouse_styles/scope_tut.png'
});
$("#tut_photo_4").attr({
src:'howtouse_styles/expsearch_tut.png'
});
...
$("div#tut_text_4").html("В StarMap есть функция расширенного поиска, которая позволяет найти все звезды, удволетворяющие введенным пользователем параметрам. При щелчке на подходящую звезду на карте отобразится ее положение и выведется вся информация о ней.");
